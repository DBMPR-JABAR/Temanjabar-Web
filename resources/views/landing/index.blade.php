    ...
    <nav class="navbar navbar-expand-lg transparent-bg static-nav">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img
                    src="{{ asset('assets/images/brand/text_putih.png') }}"
                    alt=" logo"
                    class="logo-default"
                />
                <img
                    src="{{ asset('assets/images/brand/text_hitam.png') }}"
                    alt="logo"
                    class="logo-scrolled"
                />
            </a>
                ...
                <ul class="mx-auto navbar-nav ml-xl-auto mr-xl-0">
                    ...
                    <li class="nav-item dropright">
                        ...
                        >
                            ...
                            <a
                                class="dropdown-item"
                                href="{{ url('map/map-dashboard-masyarakat') }}"
                                >Kegiatan DBMPR</a
                            >
                        </div>
                    </li>
    ...
    <div class="opacity-0 side-menu gradient-bg">
        ...
        <div class="inner-wrapper">
            ...
            <div class="side-footer w-100">
                ...
                <p class="whitecolor">
                    &copy; <span id="year"></span> {{$profil->nama}}
                </p>
            </div>
        </div>
    </div>
...
<section id="home" class="position-relative">
    ...
    >
        ...
        >
            <ul>
                @php $n = 1; @endphp @foreach ($slideshow as $slide)
                <li
                    data-index="rs-0{{ $n }}"
...
<section id="video" class="single-feature">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <a
                    href="{{ route('announcementShow', $item->slug) }}"
                    target="_blank"
                >
        ...
        <div class="text-center row align-items-center">
            <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                <div class="counters whitecolor top10 bottom10">
                    <span
                        ...
                        data-to="{{ $profil->pencapaian_selesai }}"
                        data-speed="2500"
                    >
                    </span>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                <div class="counters whitecolor top10 bottom10">
                    <span
                        class="font-light count_nums"
                        data-to="{{ $profil->pencapaian_target }}"
                        data-speed="2500"
                    >
                    </span>
                </div>
...
<section id="laporan" class="bglight position-relative padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div
                    class="alert alert-{{ Session::get('color') }} alert-dismissible fade show"
                    role="alert"
                >
        ...
        <div class="row">
            <div class="col whitebox wow fadeInLeft">
                <div class="widget logincontainer">
                    ...
                    <form
                        action="{{ route('tambah-laporan') }}"
                        method="POST"
                        class="getin_form border-form"
                        id="register"
                    ...
                    >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group bottom35">
                                    <label class="my-1 mr-2" for="pilihanUptd"
                                        >UPTD</label
                                    >
                                    <select
                                        name="uptd_id"
                                        class="my-1 custom-select mr-sm-2"
                                        id="pilihanUptd"
                                        onchange="ubahOption()"
                                        required
                                    >
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 order-sm-2">
                    <div class="px-2 text-center contact-meta text-md-left">
                        ...
                        <p class="bottom10">
                            Senin - Jumat: {{ $profil->jam_layanan }}
                        </p>
                        <ul
