                    ...
                    <form action="{{ route('bankeu.update', $bankeu->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input name="tanggal_kontrak" value="{{ @$bankeu->tanggal_kontrak }}"
                                            type="date" class="form-control" {{@$access ? '': 'readonly'}}>
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class=" form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input name="penyedia_jasa" value="{{ @$bankeu->penyedia_jasa }}" type="text"
                                            class="form-control" placeholder="" required {{@$access ? '': 'readonly'}}>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class=" form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input name="konsultasi_supervisi" value="{{ @$bankeu->konsultasi_supervisi }}"
                        ...
                        <div class=" form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input name="nama_ppk" value="{{ @$bankeu->nama_ppk }}" type="text"
                                            class="form-control" placeholder="" required {{@$access ? '': 'readonly'}}>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class=" form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input name="nama_se" value="{{ @$bankeu->nama_se }}" type="text"
                                            class="form-control" placeholder="" {{@$access ? '': 'readonly'}}>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class=" form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($access)
                                <select id="ruas_jalan" style="width: 100%" class="searchableField" name="geo_id"
                                ...
                                <input  id="ruas_jalan"  name="geo_id" value="{{ @$ruas_jalan_selected->geo_id }}"
                                    style="display:none" />
                                <input value="{{ @$ruas_jalan_selected->nama_ruas_jalan }}" type="text"
                                    class="form-control" required readonly>
                                @endif
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <select id="ditunjukan_untuk" class="form-control form-select searchableField"
                                                ...
                                                <option value="{{ $data->id }}" @isset($ditunjukan_untuk)
                                                    @foreach ($ditunjukan_untuk as $exits)
                                ...
                                <div class="tab-content tabs card-block" id="bukti_content_container">
                                    <div class="tab-pane active" id="bukti_1" role="tabpanel">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input id="foto_1_1" name="foto_1_1" type="file" accept="image/*"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input id="foto_1_2" name="foto_1_2" type="file" accept="image/*"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input id="foto_1_3" name="foto_1_3" type="file" accept="image/*"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input id="video_1" name="video_1" type="file" accept="video/mp4"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input id="dokumen_1" name="dokumen_1" type="file"
