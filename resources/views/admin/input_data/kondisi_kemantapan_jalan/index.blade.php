            ...
            <div class="card">
                ...
                <div class="card-block">
                    @if (hasAccess(Auth::user()->internal_role_id, 'Kondisi Jalan', 'Create'))
                        <a href="{{ route('kondisi_jalan.create') }}" class="btn btn-mat btn-primary mb-3">Tambah</a>
                    @endif
                    <div class="dt-responsive table-responsive">
                        <table id="kondisi_jalan-table" class="table table-striped table-bordered able-responsive">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    {{-- <th>No Ruas</th>
