      ...
      <div class="card">
        ...
        <div class="pb-5 pl-5 pr-5 card-block">
          ...
          @if ($action == 'store')
            ...
            @else
              <form action="{{ route('bankeu.update', $bankeu->id) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
          @endif
          @csrf
                ...
                <div class="col-md-12">
                  <select class="form-control" id="edit_uptd" name="unor" required>
                    ...
                    @foreach ($uptd_lists as $data)
                      <option value="{{ 'uptd' . $data->id }}" id="uptd_{{ $data->id }}" @isset($bankeu)
              ...
              <div class="row">
                <div class="col-md-12">
                  <input name="nama_kegiatan" value="{{ @$bankeu->nama_kegiatan }}" type="text" class="form-control"
                    placeholder="Bantuan keuangan perbaikan jalan" required>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-6">
                  <input name="no_spmk" value="{{ @$bankeu->no_spmk }}" type="text" class="form-control"
                    placeholder="">
                </div>
                <div class="col-md-6">
                  <input name="tanggal_spmk" value="{{ @$bankeu->tanggal_spmk }}" type="date" class="form-control">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-12">
                  <input name="ppk_kegiatan" value="{{ @$bankeu->ppk_kegiatan }}" type="text" class="form-control"
                ...
                <div class="col-md-12">
                  <select class="form-control" name="konsultasi_supervisi" required>
                    ...
                    @foreach ($konsultan as $data)
                      <option value="{{ $data->nama }}" @isset($bankeu)
                        {{ $bankeu->konsultasi_supervisi == $data->nama ? 'selected' : '' }} @endisset>
                        {{ $data->nama }}</option>
                    @endforeach
                  </select>
                </div>
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-6">
                  <input name="nama_sse" value="{{ @$bankeu->nama_sse }}" type="text" class="form-control"
                    placeholder="">
                </div>
                <div class="col-md-6">
                  <input name="nama_gs" value="{{ @$bankeu->nama_gs }}" type="text" class="form-control">
                </div>
              </div>
            </div>
          </div>
...
<div class=" form-group row">
    ...
    <div class="col-md-8">
        <div class="row">
          ...
          <small class="mb-1">*Jika tidak terdapat pada ruas jalan yang tersedia, anda dapat menggambar manual
            dengan klik icon
