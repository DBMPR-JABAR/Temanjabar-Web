    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="pb-5 pl-5 pr-5 card-block">
          ...
          @if ($action == 'store')
            <form action="{{ route('bankeu.store') }}" onsubmit="return Validate(this);" method="post"
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-12">
                  <input name="pemda" value="PEMERINTAH PROVINSI JAWA BARAT" type="text" readonly class="form-control"
                    placeholder="PEMERINTAH PROVINSI JAWA BARAT" required>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-12">
                  <input name="opd" value="DINAS BINA MARGA DAN PENATAAN RUANG" readonly type="text"
                    class="form-control" placeholder="DINAS BINA MARGA DAN PENATAAN RUANG" required>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-12">
                  @if ($access)
                    <select class="form-control searchableField" name="kab_kota" required {{ @$access ? '' : 'readonly' }}>
                  ...
                  @else
                    <input name="kab_kota" value="{{ @$bankeu->kab_kota }}" type="text" class="form-control" required
                      readonly>
                  @endif
                </div>
              </div>
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-12">
                  ...
                  @else
                    <input name="kategori" value="{{ @$bankeu->kategori }}" type="text" class="form-control" required
                      readonly>
                  @endif
                </div>
              </div>
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-12">
                  <input name="nama_kegiatan" value="{{ @$bankeu->nama_kegiatan }}" type="text" class="form-control"
                    placeholder="Bantuan keuangan perbaikan jalan" required {{ @$access ? '' : 'readonly' }}>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-6">
                  <input name="panjang" value="{{ @$bankeu->panjang }}" type="number" class="form-control"
                    placeholder="" {{ @$access ? '' : 'readonly' }}>
                </div>
                <div class="col-md-6">
...
class="form-control" placeholder="" required {{@$access ? '': 'readonly'}}>
          ...
          <div class=" form-group row">
            ...
            <div class="col-md-8">
              ...
              @else
                <input id="ruas_jalan" name="geo_id" value="{{ @$ruas_jalan_selected->geo_id }}"
                  style="display:none" />
                <input
          ...
          <div class=" form-group row" id="nama_lokasi">
            ...
            <div class="col-md-8">
              <input id="nama_lokasi_value" name="nama_lokasi"
                value="{{ @$bankeu->nama_lokasi ? $bankeu->nama_lokasi : '-' }}" type="text" class="form-control"
                {{ @$access ? '' : 'readonly' }}>
            </div>
          </div>
          ...
          <small class="mb-1">*Jika tidak terdapat pada ruas jalan yang tersedia, anda dapat menggambar
            ...
            polyline pada peta, gunakan jarak zoom terdekat untuk lebih presisi. atau upload file shp (membutuhkan waktu
            untuk
          ...
          @if (hasAccess(Auth::user()->internal_role_id, 'Verifikasi Bantuan Keuangan', 'Update'))
    ...
    <div class=" form-group row">
      ...
      <div class="col-md-8">
        <div class="row">
          ...
          <div class="col-md-6">
            <input name="tanggal_kontrak" value="{{ @$bankeu->tanggal_kontrak }}" type="date" class="form-control"
              {{ @$access ? '' : 'readonly' }}>
          </div>
        </div>
      </div>
    ...
    <div class=" form-group row">
      ...
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-12">
            <input id="konsultasi_supervisi" name="konsultasi_supervisi" value="{{ @$bankeu->konsultasi_supervisi }}"
              type="text" class="form-control" placeholder="" required {{ @$access ? '' : 'readonly' }}>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-5">
            ...
            <input name="pembagian_progres_view" id="pembagian_progres" value=" @if (@$bankeu->pembagian_progres == '1') Tahunan @elseif(@$bankeu->pembagian_progres == "
      ...
      <div class="tab-content tabs card-block" id="bukti_content_container">
        <div class="tab-pane active" id="bukti_1" role="tabpanel">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-5">
              <input id="dokumen_1" name="dokumen_1" type="file" accept="application/pdf" class="form-control">
            </div>
          </div>
        </div>
      </div>
...
@section('script')
  ...
  <script type="text/javascript">
    const url = "{{ url('/admin/bidtek/bankeu/get_ruas_jalan_by_geo_id') }}"
