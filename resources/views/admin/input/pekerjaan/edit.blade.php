            ...
            <div class="card-block">
                ...
                <form action="{{ route('updateDataPekerjaan', $pekerjaan->id_pek) }}" method="post"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="sub_kegiatan" type="text" value="{{ $pekerjaan->sub_kegiatan }}"
                                placeholder="Entry Sub Kegiatan" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        @if (Auth::user()->internalRole->role != null && str_contains(Auth::user()->internalRole->role,
                        'Mandor'))
                        <div class="col-md-10">
                        ...
                        <div class="col-md-10">
                            <select class="form-control searchableField" name="nama_mandor" required>
                                ...
                                <option value="{{ $data->name }},{{ $data->id }}" {{ $data->id == $pekerjaan->user_id ?
                                    'selected' : '' }}>
                                    {{ $data->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control searchableField" name="jenis_pekerjaan" required>
                                ...
                                <option value="{{ $data->id }}" {{ $data->id == $pekerjaan->jenis_pekerjaan ? 'selected'
                                    : '' }}>
                                    {{ $data->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control searchableField" id="uptd" name="uptd_id"
                                ...
                                <option value="{{ $data->id }}" {{ $data->id == $pekerjaan->uptd_id ? 'selected' : ''
                                    }}>
                                    {{ $data->nama }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control searchableField" id="sup" name="sup" required
                                ...
                                <option></option>
                                @foreach ($sup as $data)
                                <option value="{{ $data->name }},{{ $data->id }}" {{ $data->name == $pekerjaan->sup ?
                                    'selected' : '' }}>{{ $data->name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control searchableField" id="ruas_jalan" name="ruas_jalan" required
                                ...
                                <option value="{{ $data->nama_ruas_jalan }},{{ $data->id_ruas_jalan }}" {{ $data->
                                    id_ruas_jalan == $pekerjaan->ruas_jalan_id ? 'selected' : '' }}>
