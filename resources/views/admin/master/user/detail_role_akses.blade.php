            ...
            <div class="tab-content tabs card-block">
                <div class="tab-pane active" id="Detail" role="tabpanel">
                     ...
                     <tr><td>	User Role</td><td>{{$user_role_list[0]->role}}</td></tr>
                      <tr><td>	Menu</td><td>{{$user_role[0]->menu}}</td></tr>
                      <tr><td>  Role Access</td>
                      <td><?php
                                         $i=0;
                                         while($i< count($role_access)){
                                             if($role_access[$i]->master_grant_role_aplikasi_id == $user_role[0]->id){
                      ...
                      <td><?php
                                         ...
                                         while($i< count($uptd_access)){
                                             if($uptd_access[$i]->master_grant_role_aplikasi_id == $user_role[0]->id){
