            ...
            <div class="card">
                ...
                <div class="card-block">
                    <div class="form-group">
                        ...
                        <input name="nama" placeholder="Enter your First name" type="text" value="{{ old('nama', $profile->nama) }}" class="form-control  @error('nama') is-invalid @enderror">
                        @error('nama')
                    ...
                    <div class="form-group">
                        <label>NIP</label>
                        <input name="no_pegawai" placeholder="Enter NIP" type="text" value="{{ old('no_pegawai', $profile->no_pegawai) }}" class="form-control  @error('no_pegawai') is-invalid @enderror">
                        @error('no_pegawai')
                        <div class="invalid-feedback" style="display: block; color:red">
                            {{ $message }}
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="tmp_lahir" placeholder="Masukan Tempat lahir" type="text" value="{{ old('tmp_lahir', $profile->tmp_lahir) }}" class="form-control @error('tmp_lahir') is-invalid @enderror" required>
                                @error('tmp_lahir')
                                <div class="invalid-feedback" style="display: block; color:red">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="tgl_lahir" placeholder="Enter your date" type="date" value="{{ old('tgl_lahir', $profile->tgl_lahir) }}" class="form-control @error('tgl_lahir') is-invalid @enderror">
                                @error('tgl_lahir')
                                <div class="invalid-feedback" style="display: block; color:red">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Telepon</label>
                                <input type="text" name="no_tlp" id="no_tlp" value="{{ old('no_tlp', $profile->no_tlp) }}" placeholder="Masukan Nomer Telepon"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_tlp_rumah" id="no_tlp_rumah" value="{{ old('no_tlp_rumah', $profile->no_tlp_rumah) }}" placeholder="Masukan Telepon Rumah"
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tgl_mulai_kerja" placeholder="Tanggal Mulai Kerja" type="date" value="{{ old('tgl_mulai_kerja', $profile->tgl_mulai_kerja) }}" class="form-control  @error('tgl_mulai_kerja') is-invalid @enderror">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <div class="form-group">
                        ...
                        <input name="sekolah" placeholder="Masukan Institusi" type="text" value="{{ old('sekolah', $profile->sekolah) }}" class="form-control  @error('sekolah') is-invalid @enderror">
                        @error('sekolah')
                        <div class="invalid-feedback" style="display: block; color:red">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="jurusan_pendidikan" placeholder="Masukan Jurusan" type="text" value="{{ old('jurusan_pendidikan', $profile->jurusan_pendidikan) }}" class="form-control  @error('jurusan_pendidikan') is-invalid @enderror">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="form-group">
                        ...
                        <input name="kode_pos" placeholder="Masukan Jurusan" type="text" value="{{ old('kode_pos',$profile->kode_pos) }}" class="form-control  @error('kode_pos') is-invalid @enderror">
                        @error('kode_pos')
                        <div class="invalid-feedback" style="display: block; color:red">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" placeholder="Masukan Alamat Lengkap" class="form-control  @error('alamat') is-invalid @enderror">{!! $profile->alamat !!}</textarea>
                        @error('alamat')
                        <div class="invalid-feedback" style="display: block; color:red">
                            {{ $message }}
                        </div>
