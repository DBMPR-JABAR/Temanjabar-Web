                    ...
                    <form action="{{ route('createJembatan') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="id_jembatan" type="text" class="form-control" maxlength="10"
                                        placeholder="Contoh : 22.017.005" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 my-auto">
                                    <input name="nama_jembatan" type="text" class="form-control"
                                        placeholder="Contoh : Cihaurwangi" required>
                                </div>
                            </div>
                            {{-- <div class="form-group row">
                            ...
                            @else
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control searchableField" id="uptd" name="uptd" required
                                            onchange="ubahOption()">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select id="ruas_jalan" id="ruas_jalan" name="ruas_jalan"
                                        class="form-control searchableField" required>
                                        @if (Auth::user()->internalRole->uptd)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="lokasi" type="text" class="form-control"
                                        placeholder="Contoh : Km. Bdg. 40 + 540" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 my-auto">
                                    <input name="panjang" type="text" class="form-control formatRibuan"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="lebar" type="text" class="form-control formatRibuan"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="tinggi_muka_air_banjir" type="text" class="form-control formatRibuan"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="kondisi" type="text" class="form-control"
                                        placeholder="Contoh Baik, tambah keterangan jika perlu" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="tipe" type="text" class="form-control" placeholder="GTI, RBB, RBA"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 my-auto">
                                    <input id="jumlah_bentang" name="jumlah_bentang" type="number" class="form-control"
                                        step="any" placeholder="Contoh 1" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 my-auto">
                                    <input id="long" name="lng" type="text" class="form-control formatLatLong"
                            ...
                            <div id="inputFormRow">
                                <div class="input-group">
                                    <input type="text" name="nama[]" class="form-control m-input" placeholder="Judul Foto"
                    ...
                    $.ajax({
                        ...
                        complete: function(result) {
                            ...
                            result.responseJSON.forEach(function(item) {
                                textOption += '<option value="' + item['id'] + '">' +
                                    item['nama'] + '</option>'
                            });
                            ...
                            for (var j = 0; j < jumBentang; j++) {
                                text = '<div class="form-group row w-100 mx-auto">' +
                                    ...
                                    '<input name="panjangBentang' + j +
                                    '" type="number" class="form-control h-100" step="any" required></div>' +
                                    '<div class="col-md-5">' +
                                    '<select class="form-control" name="tipe' + j +
                                    '" required>' +
