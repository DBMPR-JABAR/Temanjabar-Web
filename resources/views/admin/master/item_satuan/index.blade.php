        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    @if (hasAccess(Auth::user()->internal_role_id, 'Item Satuan', 'Create'))
                                    ...
                                    <tr>
                                        ...
                                        <td style="min-width: 75px;">
                                            <div class="btn-group " role="group" data-placement="top" title=""
                                                ...
                                                @if (hasAccess(Auth::user()->internal_role_id, 'Item Satuan', 'Update'))
                                                    <a href="{{ route('item_satuan.edit', $data->no) }}"><button
                                                            class="btn btn-primary btn-sm waves-effect waves-light"
                                                            data-toggle="tooltip" title="Edit"><i
                                                                class="icofont icofont-pencil"></i></button></a>
                                                @endif
                                                @if (hasAccess(Auth::user()->internal_role_id, 'Item Satuan', 'Delete'))
