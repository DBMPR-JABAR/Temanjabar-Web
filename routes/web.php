...
Route::get('/map-dashboard/intervention-mage/laporan_masyarakat/{value}', function($value) {
    $img = Image::make(url('storage/laporan_masyarakat/'.$value))->resize(400, 400, function ($constraint) {
        $constraint->aspectRatio();
        $constraint->upsize();
    });
    $height = $img->height();
